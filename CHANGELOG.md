...
- **Client Portal API Alignment** (2026-01-21)
  - **T-145**: Switched client portal frontend API calls to `/portal/*` paths relative to the `/api` base URL, keeping portal document routing and coverage tests aligned.
