...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name="project",
            index=models.Index(
                fields=["client", "status"], name="projects_pr_client__cfb69e_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="project",
            index=models.Index(
                fields=["project_manager"], name="projects_pr_project_45b1b8_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="project",
            index=models.Index(
                fields=["project_code"], name="projects_pr_project_d08b35_idx"
            ),
        ),
    ]
