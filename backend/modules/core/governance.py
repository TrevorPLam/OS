...
Implements the data classification system defined in the data governance spec.
...
Usage:
    from modules.core.governance import DataClassification, governance_registry
...
def redact_for_logging(entity: str, data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    Usage:
        from modules.core.governance import redact_for_logging
...
def get_sensitive_fields(entity: str) -> Set[str]:
    ...
    Usage:
        from modules.core.governance import get_sensitive_fields
...
def requires_access_logging(entity: str, field: Optional[str] = None) -> bool:
    ...
    Usage:
        from modules.core.governance import requires_access_logging
