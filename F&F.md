...
## Navigation-based Grouping (from UI Navigation)

This ordering follows the sidebar navigation in `src/frontend/src/components/Layout.tsx`.
Module-to-navigation alignment below is inferred from module naming and route labels; validate if uncertain.

### CRM & Sales (Navigation)
...
- No directly named module sections map to this navigation group (UNKNOWN).
...
## Other Modules (Not Exposed in Navigation)
