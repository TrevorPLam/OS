    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('ingestion', 'Ingestion'), ('sync', 'Sync'), ('recurrence', 'Recurrence'), ('orchestration', 'Orchestration'), ('documents', 'Documents'), ('notifications', 'Notifications'), ('export', 'Export'), ('maintenance', 'Maintenance')], help_text='Job category per docs/03-reference/requirements/DOC-20.md section 1', max_length=20)),
                ...
                ('idempotency_key', models.CharField(help_text='Unique key for at-most-once processing per docs/03-reference/requirements/DOC-20.md section 3', max_length=255)),
                ('correlation_id', models.UUIDField(help_text='Correlation ID for tracing across systems per docs/03-reference/requirements/DOC-20.md section 2')),
