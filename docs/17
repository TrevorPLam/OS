...
> **⚠️ Current vs Intended Structure**
> The repository currently uses a Django monolith structure, which intentionally differs from this blueprint.
> See [repo-structure-delta.md](repo-structure-delta.md) for detailed analysis, rationale, and migration path.
> This document remains the aspirational target for when the team scales or service extraction is required.
