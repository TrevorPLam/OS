...
Use this guide to find the right documentation quickly. We follow the Diátaxis framework to keep docs focused and useful.
...
- **[Getting Started Tutorial](01-tutorials/README.md)** - Complete setup guide for new developers
...
- **[Code Audit](../CODEAUDIT.md)** - Code audit pipeline
- **[Documentation Governance](../DOCSAUDIT.md)** - Documentation audit runbook
...
- **[API Reference](03-reference/api/README.md)** - Complete API documentation
...
- **[Production Deployment](02-how-to/README.md)** - Deploy to production
...
- **[Data Retention](DATA_RETENTION_IMPLEMENTATION.md)** - Automated data retention policies
...
### User Guides
- **[User Guides Index](06-user-guides/README.md)** - End-user guides for administrators and portal users

### Implementation Tracking
- **[Project Status](../PROJECT_STATUS.md)** - Current status and next steps
- **[Enhancement Summary](ENHANCEMENT_SUMMARY.md)** - Governance framework updates

### System Specifications
- **[System Invariants](specs/spec/SYSTEM_INVARIANTS.md)** - Core system rules
- **[System Spec Alignment](SYSTEM_SPEC_ALIGNMENT.md)** - Spec alignment documentation

### Other Resources
- **[Changelog](../CHANGELOG.md)** - Release history and changes
- **[Documentation Style Guide](STYLE_GUIDE.md)** - How we organize and write docs
...
*See full list in the implementation docs above.*
